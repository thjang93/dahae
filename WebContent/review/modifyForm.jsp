	...
	<body>
		<div id="wrapper">
			...
			<div class ="container">
				...
				<form method="post" action="reviewModifyView.do" name="passwdform"
					onsubmit="return rmembercheckRe(${sessionScope.memId})">
					<input type="hidden" name="num" value="${num}"> <input
						type="hidden" name="pageNum" value="${pageNum}">
					<table style="margin-right: auto; margin-left: auto;">
						<tr>
							<td align="center"
								style="height: 100px; width: 300px; font-size: 16px;">
								${msg_modify_check}</td>
						</tr>
						<tr>
							...
							<input class="btn btn-default btn-sm" type="button" value="${btn_mod_cancel}"
								onclick="location='reviewList.do?pageNum=${pageNum}'"></th>
						</tr>
					</table>
				</form>
				</div>
