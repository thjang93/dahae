		...
		<div id="main">
			<div class="container">
				<div align="center">
					...
					<b style="font-size:15px;">${msg_modify}</b> <br>
						...
						<form method="post" action="momodifyPro.do"
							...
							<div class="form-group">
								...
								<div class="form-group">
									...
									<input type="password" name="repasswd" class="form-control" id="InputPassword2"
								...
								<div class="form-group text-center" style="magin-top: 10px;">
									...
									<input class="btn btn-default btn-sm" type="button"
										value="${btn_mod_cancel}" onclick="location='memberList.do'">
								</div>
							</div>
						</form>
					</div>
