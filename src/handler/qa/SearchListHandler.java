...
public class SearchListHandler implements CommandHandler{
	...
	public String process
		...
		count = qaDao.getSearchCount( search_code, keyword );
		...
		if( count != 0 ){
			ArrayList<QaDataBean> articles = qaDao.getSearchArticles( start, end, search_code, keyword );
